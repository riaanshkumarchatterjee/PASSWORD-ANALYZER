...
def rate(score):
    ...
    if score >= 65:
        return "🛡️ HIGH SECURITY - Estimated to take years to crack."
    elif score >= 50:
        return "✅ GOOD SECURITY - Estimated to take months to a year to crack."
    elif score >= 35:
        return "⚠️ MEDIUM RISK - Estimated to take days to a few weeks to crack. Immediate improvement suggested."
    elif score >= 20:
